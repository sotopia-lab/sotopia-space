...
def prepare_model(model_name):
    ...
    if 'cmu-lti/sotopia-pi-mistral-7b-BC_SR'in model_name:
        tokenizer = AutoTokenizer.from_pretrained("mistralai/Mistral-7B-Instruct-v0.1", token="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")
        ...
        token="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"
        )
